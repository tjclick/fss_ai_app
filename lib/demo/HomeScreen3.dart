...
class _HomeScreenState extends State<HomeScreen3> {
  ...
  static List<Widget> _widgetOptions = <Widget>[
    _buildImage('assets/images/demo_home01.png'),
    _buildImage('assets/images/demo_company01.png'),
    _buildImage('assets/images/demo_daily01.png'),
    _buildImage('assets/images/demo_volume01.png'),
  ];
